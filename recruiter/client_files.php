    ...
    <div class="container">
        <div class="small_container">
            ...
            <div class="options">
                ...
                <p><a href="client_jobs.php">Hires</p>
                <p><a href="client_contacts.php">Contacts</p>
                <p><a href="client_appointments.php">Appointments</p>
                <p><a href="client_activity.php">Activity</p>
                <p style="color:#3598DB;margin-left:-2px"> <b style="margin-right: 10px;">|</b>Files</p>
                <p><a href="client_notes.php">Notes</p>
            </div>
            ...
            <div class="status">
                ...
                <div class="status-name" style="margin-top:30px;">
                    <span style="margin-left:50px;color:black">Fox Hunt</span>
            ...
            <div class="left-side-container-1">
                    <span class="row-recruiter upcoming_interview_top_span">
                        ...
                        <input class="search-form-input" type="search" name="search" placeholder="Search by File name">
                ...
                <div class="row">
                    ...
                    <div class="column">
                         <p class="col-2">Filename.pdf</p>
                        <span class="col-span-2">300kb</span>
                        
                    </div>
                    <div class="column">
                        <p class="col-3">Resume</p>
                    ...
                    <div class="column">
                        ...
                        <span class="col-span-6">Download <i class="fa fa-file" aria-hidden="true"></i></span>
                    </div>
                </div>
