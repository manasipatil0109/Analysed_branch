...
<link rel="stylesheet" href="./css/settings_notifications.css">
<div class="container">
        <div class="small_container" style="margin-left:200px">
            <div class="heading_dash">
                <h1 class="mainHeadingDash">Settings <i class="fa fa-cog" aria-hidden="true"></i></h1>
                <p class="mainParaDash" id="te1">Confire the system to cater to your needs.</p>
            </div>
            <div class="small_container row_for_settings" style="margin-left:200px">
