    ...
    <div class="row-recruiter quickaccess-links-container">
      ...
      <details id="dropdown" class="dropdown">
          <summary class="dropdown-button">
            <span id="selected-item" class="selected-item">All types</span>
          </summary>
        ...
        <button class="searchButton" style="margin-right:40px;">
         ...
         <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <div class="heading_dash">
                    ...
                    <p class="mainParaDash" style="color:#979797;margin-left:30px;margin-bottom:50px">Select a pre-defined user type or create a new one</p>
                </div>
            ...
            <div class="heading_dash">
                    <h1 class="mainHeadingDash" style="font-size:15px;color:#333333;margin-left:30px">Create custom user
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16"><path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/></svg></h1>
